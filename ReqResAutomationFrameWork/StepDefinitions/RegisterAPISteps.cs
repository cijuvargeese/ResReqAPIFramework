...
namespace ReqResAutomationFrameWork.StepDefinitions
{
	...
	public class RegisterAPISteps : BaseSteps
	{
		...
		{
			registerRequestDTO.password = HandlePassword.DecryptString(registerRequestDTO.password);
			Assert.IsNotNull(registerRequestDTO.password, "decryption of password might have thrown as exception");
			//HandlePassword.EnryptString(password);
		}

		[Given(@"set password as null")]
		public void GivenSetPasswordAsNull()
		{
